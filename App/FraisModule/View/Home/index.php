  ...
  <!-- Wrapper for slides -->
	<div class="carousel-inner" role="listbox">
		<div class="item active">
		  <img src="<?php echo $this->asset('img/pharmacy5.jpg');?>" alt="...">
		  <div class="carousel-caption">
			<h1>Appli frais</h1>
		  </div>
		</div>
		<div class="item">
		  <img src="<?php echo $this->asset('img/pharmacy1.jpg');?>" alt="...">
		  <div class="carousel-caption">
			<h1>Gestion Compte-rendus</h1>
		  </div>
		</div>
		<div class="item">
		  <img src="<?php echo $this->asset('img/pharmacy3.jpg');?>" alt="...">
		  <div class="carousel-caption">
			<h1>Gestion des incidents</h1>
		  </div>
		</div>
		<div class="item">
		  <img src="<?php echo $this->asset('img/pharmacy4.jpg');?>" alt="...">
		  <div class="carousel-caption">
			<h1>Back office</h1>
		  </div>
		</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="jumbotron jumbo-no-padding"><h4 class="text-muted">Notre mission : servir l'humanité</h4></div>
			</div>
		</div>
